...
<script>
    ...
    function closeSuccessRefundModal() {
        // tutup modal sukses lalu reload agar tabel sinkron
        document.getElementById('successRefundModal').classList.add('hidden');
        location.reload();
    }
    // --- Minimal change: intercept submit form dan gunakan fetch ---
    (function () {
        const form = document.getElementById('deleteRefundForm');
        ...
        form.addEventListener('submit', function (e) {
            ...
            .then(async res => {
                if (res.ok) {
                    ...
                    document.getElementById('successRefundModal').classList.remove('hidden');
                } else {
                    // coba baca pesan error jika ada
                    let msg = 'Gagal menghapus refund.';
                    try {
            ...
            .catch(err => {
                ...
                alert('Terjadi kesalahan saat menghapus refund.');
            })
            .finally(() => {
                if (submitBtn) {
