    ...
    <div class="mt-2 flex justify-between items-center">
        @if(!request()->route('user'))
            ...
            <a href="{{ route('superadmin.users.export', request()->query()) }}"
               class="flex items-center gap-2 mt-6 bg-yellow-200 hover:bg-yellow-300 text-black font-semibold px-4 py-1 rounded-md shadow transition">
        ...
        @else
            ...
            <div class="flex justify-between items-center w-full mt-4">
                <div class="flex items-center gap-3 ml-6">
                    ...
                    <h2 class="text-[32px] font-semibold text-blue-900">Detail Pengguna</h2>
                </div>

                <!-- UNDUH DI DETAIL -->
                <a href="{{ route('superadmin.users.export', ['user' => request()->route('user')]) }}"
