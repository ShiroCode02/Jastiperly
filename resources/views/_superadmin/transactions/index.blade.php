            ...
            <div id="navbar-header" class="fixed top-0 left-97 right-0 z-20 transition-all duration-300 initial-hidden"
                ...
                <div class="mt-2 flex justify-between items-center">
                    ...
                    <form method="GET" class="flex flex-wrap gap-3">
                        <!-- Filter Tipe -->
                        <select name="type"
                            class="border border-blue-400 rounded-md px-3 py-2 text-blue-800 font-medium 
                                   bg-white hover:bg-blue-500 hover:text-white hover:shadow-md
                                   focus:bg-blue-600 focus:text-white focus:ring focus:ring-blue-200 
