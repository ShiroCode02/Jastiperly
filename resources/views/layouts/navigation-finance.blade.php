            ...
            <div class="relative mr-6">
                <form action="{{ route(request()->route()->getName()) }}" method="GET" class="flex items-center">
                    <input type="text" 
                           ...
                           class="w-96 pl-12 pr-4 py-2 bg-white border border-gray-300 rounded-md text-gray-700 
                                  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    
                    <!-- Background biru + Ikon kaca pembesar -->
                    <div class="absolute inset-y-0 left-0 w-10 flex items-center justify-center bg-[#78B3CE] rounded-l-md pointer-events-none">
