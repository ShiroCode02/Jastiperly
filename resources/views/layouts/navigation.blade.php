...
<nav class="flex items-center justify-between h-16 bg-white border-b border-gray-200 shadow-sm px-6">
    <!-- Kiri: Judul Halaman -->
        ...
        <x-dropdown align="right" width="48">
            <x-slot name="trigger">
                <button class="flex items-center gap-2 text-gray-700 focus:outline-none">
                    <img src="{{ asset('images/profile.jpg') }}" alt="Profile" class="w-9 h-9 rounded-full border">
